...
const themes = [
    ...
    { name: "Purple", class: "theme-purple", color: "bg-purple-600" },
    { name: "Red", class: "theme-red", color: "bg-red-600" },
    { name: "Teal", class: "theme-teal", color: "bg-teal-600" },
];
                ...
                {themes.map((theme) => (
                    ...
                    >
                        <div className="flex items-center gap-2 w-full">
                            <div
                                className={`h-4 w-4 rounded-full border ${theme.color}`}
                            ></div>
