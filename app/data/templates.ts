...
const createExercise = (id: string, sets: number = 3, reps: number = 10): WorkoutExercise => ({
    exerciseId: id,
...
export const templates: WorkoutTemplate[] = [
    {
        ...
        description: "Classic beginner routine hitting every muscle group 3x a week.",
        days: 3,
        plan: {
            1: [
    ...
    },
    {
        ...
        description: "Popular split grouping pushing, pulling, and leg movements.",
        days: 3,
        plan: {
            1: [ // Push
                createExercise('1', 3, 8), // Bench
