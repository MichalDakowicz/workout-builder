                ...
                <div className="space-y-8 py-4">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            <Badge className="px-3 py-1.5 text-sm font-medium capitalize">
                    ...
                    {exercise.gifUrl && (
                        <div className="bg-muted/50 border rounded-xl p-4">
                            ...
                            <img
                                src={exercise.gifUrl}
                                alt={exercise.name}
                                className="m-auto max-w-full max-h-full object-contain rounded-md border border-neutral-800"
                            />
                        </div>
                    )}
                        ...
                        <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-100 dark:border-yellow-900/20 rounded-xl p-5">
                            ...
                            <ul className="space-y-2">
                                {exercise.tips.map((tip, idx) => (
                                    <li
                                        key={idx}
                                        className="flex gap-2 text-yellow-700 dark:text-yellow-400/90"
                                    >
